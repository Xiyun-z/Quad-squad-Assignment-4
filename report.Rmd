...
```{r tab-vax-cases, echo = FALSE, message = FALSE, warning = FALSE,fig.cap= "top 10 countries with highest daily cases"}
sum_dat1<-dat %>% 
  group_by(location)%>%
...
```{r vax-cases, echo = FALSE, message = FALSE, warning = FALSE, results = 'hide' ,error = FALSE, fig.cap = "correlation between new cases vs fully vaccinated"}
