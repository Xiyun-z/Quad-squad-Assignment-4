...
```{r Figure 1, echo= FALSE, warning = FALSE, fig.width = 6, fig.align="center", fig.cap ="COVID-19 Daily new cases"}
...
```{r Figure 2,echo= FALSE, warning = FALSE, fig.width = 6, fig.align="center", fig.cap ="Average daily deaths attributed to COVID-19"}
...
```{r Figure 3, echo = FALSE, warining=FALSE, fig.width = 6, fig.align="center", fig.cap = "People fully vaccinated in percentage by region"}
