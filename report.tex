...
\caption{\label{tab:tab-vax-cases}top 10 countries with highest daily cases}
\centering
\begin{tabular}[t]{lrr}
\toprule{}
...
{\centering \includegraphics{report_files/figure-latex/trend-vax-cases-1} 

}

\caption{trend of new cases vs fully vaccinated}\label{fig:trend-vax-cases}
\end{figure}
...
{\centering \includegraphics{report_files/figure-latex/vax-cases-1} 

}

\caption{correlation between new cases vs fully vaccinated}\label{fig:vax-cases}
\end{figure}
\clearpage
