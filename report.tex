...
\caption{\label{tab:tab1}top 10 countries with highest daily cases}
\centering
\begin{tabular}[t]{lrr}
\toprule{}
...
\caption{trend of new cases vs fully vaccinated}\label{fig:fig2}
\end{figure}
...
{\centering \includegraphics{report_files/figure-latex/fig3-1} 

}

\caption{correlation between new cases vs fully vaccinated}\label{fig:fig3}
\end{figure}
